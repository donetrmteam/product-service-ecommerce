pipeline {
    ...
    environment {
        EC2_SERVER = '3.217.43.93'
        DEPLOY_USER = 'ubuntu'
        APP_DIR = '/home/ubuntu/product-service-ecommerce'
        APP_REPO_URL = 'https://github.com/donetrmteam/product-service-ecommerce.git'
        PORT_DEV = '3000'
        PORT_QA = '3001'
        PORT_MAIN = '3002'
    }
        ...
        stage('Deploy') {
            steps {
                script {
                    ...
                    withCredentials([sshUserPrivateKey(credentialsId: 'ssh-key-eu', keyFileVariable: 'SSH_KEY')]) {
                        sh """
